...
class PetProfileScreenHOME extends StatefulWidget {
  ...
  @override
  State<PetProfileScreenHOME> createState() => _PetProfileScreenHOMEState();
}

class _PetProfileScreenHOMEState extends State<PetProfileScreenHOME> {
  @override
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                try {
                                  ...
                                  // Update the animal-status field
                                  await docRef.update({'animal-status': 'RA7ET'});
